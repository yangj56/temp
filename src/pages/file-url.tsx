...
export function FileURL() {
    ...
    return (
        <MainLayout>
            ...
            <div style={{ display:'flex', height:'40px', justifyContent:'center', alignItems:'center' }}>One-Time Pin <input type="text" name="Enter Mobile Number" style={{ marginLeft:'50px', boxSizing: 'border-box', border: 'solid 1px', borderRadius: '4px' }}/></div>
