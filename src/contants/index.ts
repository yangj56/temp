...
export enum AppState {
  ...
  ENCRYPT_PRIVATE_KEY_WITH_PASSWORD = "Encrypting user's private key with password",
  ...
  ENCRYPT_DATA_KEY_WITH_PIN = 'Encrypting the data key with PIN',
  ...
  UPLOADING_ENCRYPTED_PRIVATE_KEY = "Uploading user's encrypted private key and public key",
  UPLOADING_ENCRYPTED_FILE = 'Uploading encrypted file',
  UPLOADING_ENCRYPTED_DATA_KEY = 'Uploading encrypted data key',
  SHARE_FILE_TO_USER = 'Upload encrypted data key',
  PREPARE_FILE_FOR_DOWNLOAD = 'Prompting file for download',
  DECRYPT_DATA_KEY_PIN = 'Decrypting data key with PIN',
  IDLE = 'Idle',
  ACTION_LOGIN = '[Action] Login',
  ACTION_RETRIEVAL_USER_DATA = '[Action] Retrieve user data',
